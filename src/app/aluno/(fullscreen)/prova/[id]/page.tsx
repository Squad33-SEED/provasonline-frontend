...
const questoes = [
  {
    id: 1,
    enunciado: "Considere o triângulo retângulo ABC, com catetos de 6 cm e 8 cm. Qual o valor da hipotenusa?",
    assunto: "Geometria",
    dificuldade: "FACIL",
    alternativas: [
      { id: "a", texto: "10 cm" },
  ...
  {
    id: 2,
    enunciado: "Resolva a equação quadrática 2x² − 5x + 2 = 0 e marque o conjunto solução.",
    assunto: "Álgebra",
    dificuldade: "MEDIO",
    alternativas: [
      { id: "a", texto: "S = {1/2, 2}" },
  ...
  {
    id: 3,
    enunciado: "Calcule o valor de sen(45º) + cos(45º).",
  ...
  {
    id: 5,
    enunciado: "Se um objeto tem massa 10 kg e aceleração 3 m/s², qual a força resultante?",
    assunto: "Física",
    dificuldade: "FACIL",
    alternativas: [
      { id: "a", texto: "13 N" },
